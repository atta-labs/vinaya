...
| `task status` | `task-status.ts` | `taskStatusCommand` | 2 | exempt — see below | taskStatus (target) |
...
| `task status` | 2026-09-11 | 2 — lib: `printJson`, `gatherTaskStatusList` | `taskStatus` |
