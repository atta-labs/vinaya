...
`
  ...
  it('parses the real enforcement.md — 34 rows (35 minus the retired stale-blocker ring-2 row), only non-deterministic rows carry an empty implementation', () => {
    ...
    expect(ring0Count + ring1Count + ring2Count).toBe(34)
