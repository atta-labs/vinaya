...
`
  ...
  it('parses the real enforcement.md — 40 rows (34 plus the six standalone-shim rows G2 demanded), only non-deterministic rows carry an empty implementation', () => {
    ...
    expect(ring0Count + ring1Count + ring2Count).toBe(40)
