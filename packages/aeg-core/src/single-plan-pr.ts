/**
 * Single-plan-PR guard predicate. Extracted from
 * `bin/open-pr.ts` so the
...
/**
 * Single-plan-PR guard: refuses a plan-branch diff
 ...
 * itself — each cut from `origin/main` unaware of the other's
 * newly-cut Issue.
 *
