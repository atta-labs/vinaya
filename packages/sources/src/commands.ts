...
export const COMMANDS: readonly Command[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Requires a CLEAN checkout at the pull request's head, and refuses otherwise: Group B is regenerated by diff-scoped checks, so uncommitted or ignored files change which files are scanned and can produce a MATCH a clean checkout would not. The head is read from the forge and a mismatch refuses too — it is bound, not attested.",
