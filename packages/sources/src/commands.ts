...
export const COMMANDS: readonly Command[] = [
  ...
  },
  {
    ...
    details: [
      'Two lines at most. The first is `CONTINUE`, or `PAUSE: <reason>[ <id>]` where the reason is one of `reappearance`, `zero-deaths`, `stale` or `max-rounds`. The second appears only when the branch is behind its base, and reads `behind main by <n> — merge first`.',
